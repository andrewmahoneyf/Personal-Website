...
export const PROJECTS = [
  ...
  {
    url: 'https://info343-au16.github.io/challenges-andrewmahoneyf/chat/build/',
    image: IMAGES.slack,
    desc:
      'Test site developed for a chatroom platform like Slack utilizing Firebase for membership log-in features and a feed for messages.',
  },
];
