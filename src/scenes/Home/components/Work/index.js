  ...
  <div className="row">
    <div className="col-md-7 order-md-2">
      ...
      <p className="lead">
        ...
        powered mining computer, Andrew co-founded Coinglomerate with minds he met at the UW Blockchain Society. Andrew
        provided his expertise in the industry, hardware, Linux, and scripting to offer software solutions for mining
        and build optimized computers.
      </p>
      <p className="lead">
        Andrew has broadened his programming skills throughout his career with a notably strong background in front-end
        development. He has led various projects and teams from beginning to end with his web development company,
        DubDev, as well as through several internships. Not only does he have proficiency with web programming
    ...
    <div className="col-md-5 order-md-1">
      <div className="my-auto">
        <img className="img-fluid mx-auto box-shadow" src={IMAGES.office} alt="Generic placeholder" />
        <img className="img-fluid mx-auto mt-3 box-shadow" src={IMAGES.office2} alt="Generic placeholder" />
      </div>
    </div>
  </div>
);
